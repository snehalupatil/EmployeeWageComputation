...
public class DailyEmpWage implements IComputeEmpWage {
...
public int getTotalWage(String company) {
	...
	public static void main(String[] args) {
		IComputeEmpWage DailyEmpWage = new DailyEmpWage();
		DailyEmpWage.addCompanyEmpWage("DMART", 20,2,10);
		DailyEmpWage.addCompanyEmpWage("Reliance", 20,2,10);
		DailyEmpWage.computeEmpWage();
